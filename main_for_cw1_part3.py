...
def parametric_simulation_wall_insulation_thickness (eplus_run_path, idf_path,output_dir, parameter_key, parameter_vals,plot_column_name,y_axis_title,plot_title ):
    ...
    input(idf_path,'your_idf_path')
    input(parameter_key,'your_parameter_key')
    input(parameter_vals,'your_parameter_vals')
    input(plot_column_name,'your_plot_column_name')
    input(y_axis_title,'your_y_axis_title')
    input(plot_title,'your_plot_title')
